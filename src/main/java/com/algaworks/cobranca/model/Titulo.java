...
public class Titulo {
	...
	@Id //Propriedade que identifica a identidade
	...
	@DateTimeFormat(pattern="dd/MM/yyyy")//Para definir formato da data
	@Temporal(TemporalType.DATE) //Para Salvar apenas a data
